...
def test_click_button(page):
    ...
    expect.soft(page.locator("#offscreenButton")).to_be_hidden()
    expect.soft(page.locator("#overlappedButton")).to_be_hidden()  
    expect.soft(page.locator("#transparentButton")).to_be_hidden() 